  ...
  describe('Part II', function() {
    ...
    describe('contains', function() {
      ...
      it('should return false given an array and a value not in that array', function() {
        var array = [1, 2, 3];
        var value = 5;
        expect(_.contains(array, value)).to.be.false;// Replace this line with an `expect` statement that tests
    ...
    describe('every', function() {
      ...
      it('fails for a collection of all-falsy values', function() {
        expect(_.every([0, undefined, false], _.identity)).to.be.false;// Replace this line with an `expect` statement that tests
        // the behavior described by the `it` string
        //throw new Error('This test is missing.');
      });
